...
/**
 * todo
 * Service Provider is also a CUBA application.
 */
@Component(IdpAuthManager.NAME)
public class IdpAuthManager {

    public static final String NAME = "cuba_IdpAuthManager";
    ...
    private final Logger log = LoggerFactory.getLogger(IdpAuthManager.class);
    ...
    public static class IdpSessionPrincipal implements Principal {
